...
import type { Operation, SyncState } from "../../src/domain/repo";
import { makeTrackedFile, type TrackedFile } from "../../src/domain/tracked-file";
...
import { createRepoService } from "../../src/services/repo.service";
