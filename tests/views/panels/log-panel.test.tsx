...
import type { UseLogPanel } from "../../../src/controllers/log.controller";
import type { OperationView } from "../../../src/domain/repo";
import { destroyTestSetup, renderToFrame, type TestSetup } from "../../test-utils/render";
import { ThemeProvider } from "../../../src/views/theme";
import { describeOp, LogPanel } from "../../../src/views/panels/log-panel";
