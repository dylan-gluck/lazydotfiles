...
import type { ConflictDescriptor, SyncState } from "../../src/domain/repo";
import { ok } from "../../src/lib/result";
import type { SyncScheduler } from "../../src/services/sync.scheduler";
import type { SyncOutcome, SyncService } from "../../src/services/sync.service";
import {
  cleanState,
  initialSyncState,
  makeSyncReducer,
